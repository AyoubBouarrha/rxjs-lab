...
//from("tesst").subscribe(v => console.log(textColor('green', v)));
...
//Filter: emits all items received from the source observable that satisfy a 
        //specified comparison function known as the predicate.
